...
const App = () => {
  ...
  return (
    <div
      className={`min-h-screen selection:bg-blue-500/30 font-sans transition-colors duration-1000 overflow-x-hidden bg-white dark:bg-black`}
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {/* Dynamic Mouse Tracking Radial */}
        <div
          className="absolute inset-0 opacity-[0.25] transition-opacity duration-1000"
          style={{
      ...
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-700 ${isScrolled ? "py-4" : "py-10"}`}
      >
        <div className="max-w-7xl mx-auto px-6">
          <div
            className={`flex justify-between items-center px-8 py-3 rounded-2xl border transition-all duration-500 relative group overflow-hidden ${isScrolled ? "bg:white/20 dark:bg-black/60 backdrop-blur-2xl border-white/10 shadow-2xl" : "bg-transparent border-transparent"}`}
          >
      ...
      {/* Hero Section */}
      <header className="relative pt-64 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-blue-500/20 bg-blue-500/5 backdrop-blur-md mb-12 animate-fade-in shadow-[0_0_30px_rgba(37,99,235,0.1)]">
          ...
          <h1 className="text-[clamp(3rem,8vw,6.5rem)] font-black leading-[0.9] tracking-[-0.04em] uppercase mb-10 perspective-1000">
            <span className="block opacity-20 transform hover:scale-105 transition-transform duration-700 cursor-default">
          ...
          <p className="text-lg md:text-xl font-medium opacity-50 max-w-2xl mx-auto mb-16 leading-relaxed">
        ...
        <div className="mt-50 relative w-full overflow-hidden py-10 bg-blue-600 ">
          {/* Layer 1: Subtle background radial glow for depth */}
          ...
          {/* Layer 2: Gradient Overlays (Masking) */}
          <div className="absolute inset-y-0 left-0 w-48 bg-gradient-to-r from-blue-200 via-blue/80 to-transparent z-20 pointer-events-none" />
          ...
          {/* Layer 3: The Scroller */}
          <div className="flex w-max items-center gap-20 animate-infinite-scroll group hover:[animation-play-state:paused] cursor-pointer">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex gap-20 items-center">
                {["CSE", "ECE", "ME", "EE", "CE", "IT", "PH", "CH", "MA"].map(
                  (dept) => (
                    <span
                      key={dept + i}
                      className="relative text-8xl font-black tracking-tighter uppercase select-none transition-all duration-500
                       /* Default State: Stroked/Outline Text */
                       text-transparent [text-stroke:1px_#cbd5e1] [-webkit-text-stroke:1px_#cbd5e1]
                       /* Hover State: Solid Blue with Glow */
      ...
      <section
        id="features"
        className="py-25 px-6 relative bg-white dark:bg-blue-800/5 transition-colors duration-500 overflow-hidden"
      >
        {/* Dynamic Background Glows */}
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-[120px] opacity-50 pointer-events-none" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-indigo-100 dark:bg-indigo-900/20 rounded-full blur-[120px] opacity-50 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, idx) => (
              ...
              >
                ...
                <div
                  className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-blue-600 to-cyan-500 
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
            {stats.map((stat, idx) => (
              <div key={idx} className="flex flex-col items-center group">
                <div className="text-5xl font-black tracking-tighter mb-4 text-transparent bg-clip-text bg-gradient-to-b from-white to-blue-500/50 group-hover:scale-110 transition-transform duration-500">
                  {stat.value}
                </div>
                <div className="text-[10px] font-black uppercase tracking-[0.4em] opacity-30 flex items-center gap-2 group-hover:opacity-100 transition-opacity">
      ...
      {/* Leaderboard Section */}
      <section id="leaderboard" className="py-48 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              ...
              <p className="text-xl font-medium opacity-50 mb-12">
                Our repository is built on collective contribution. Meet the top
                nodes who have secured institutional memory.
              </p>
              <button className="group px-10 py-4 border border-white/10 rounded-xl font-black text-[10px] uppercase tracking-[0.4em] hover:bg-blue-600 transition-all flex items-center gap-4">
                View All Nodes{" "}
                <ArrowRight
                  size={14}
                  className="group-hover:translate-x-1 transition-transform"
              ...
              {topContributors.map((user, i) => (
                ...
                >
                  <div className="flex items-center gap-5">
                    <div
                      className={`w-12 h-12 rounded-xl ${user.color} flex items-center justify-center font-black text-white shadow-lg shadow-blue-500/20`}
                    >
                      {user.name[0]}
                    </div>
                    <div>
                      ...
                      <div className="text-[8px] font-bold text-blue-500 uppercase tracking-widest">
                        {user.rank} Archiver
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <div className="text-[8px] uppercase font-bold opacity-30 tracking-widest">
                      Uplinks
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
            ...
            {["System", "Resources"].map((title, idx) => (
              <div key={idx}>
                <h4 className="font-black text-[11px] uppercase tracking-[0.4em] mb-10 text-blue-500">
                  {title}
                </h4>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-8 text-[9px] font-black uppercase tracking-[0.5em] opacity-20 text-center">
