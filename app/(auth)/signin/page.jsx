      ...
      <div className="max-w-md w-full px-6 relative z-10 pt-20">
        ...
        <div className="text-center mb-8 animate-in fade-in zoom-in duration-700">
          <h2 className="text-4xl font-black text-zinc-900 dark:text-white uppercase tracking-tighter italic leading-tight">
            Portal <span className="text-blue-600">Access.</span>
          </h2>
          <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.2em] mt-3 bg-zinc-100 dark:bg-white/5 inline-block px-4 py-1.5 rounded-full border border-zinc-200 dark:border-white/5">
            Authorize secure session uplink
          </p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      type="text"
                      required
                      placeholder="Alias or Neural Mail"
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center px-1">
                    ...
                    <button
                      ...
                      className="text-[8px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-500 hover:text-zinc-900 dark:hover:text-white transition-colors"
                    >
                      Reset Key?
                    </button>
                  </div>
        ...
        <div className="mt-8 flex justify-between items-center opacity-60 dark:opacity-40">
          <div className="flex items-center gap-2">
            <Key size={12} className="text-blue-600 dark:text-blue-500" />
