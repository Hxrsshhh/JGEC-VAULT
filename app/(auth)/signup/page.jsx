        ...
        <div className="text-right">
          <div className="flex items-center gap-3 justify-end mb-1">
            ...
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-zinc-100 dark:bg-white/5 overflow-hidden">
              <img src="/logo1.webp" alt="logo" className="w-full h-full object-cover" />
            </div>
          </div>
        ...
        <div className="bg-white/97 dark:bg-black/10 backdrop-blur-2xl border border-zinc-200 dark:border-white/10 rounded-[2.5rem] p-7 shadow-2xl relative overflow-hidden ring-1 ring-black/5 dark:ring-white/5 transition-colors">
          {error && (
            <div className="mb-4 p-3 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center gap-2 animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-[9px] font-black uppercase text-red-500">{error}</p>
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[8px] font-black text-zinc-400 dark:text-zinc-600 uppercase tracking-widest">or generate key</span>
              <div className="h-px flex-grow bg-zinc-200 dark:bg-white/5"></div>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="grid grid-cols-1 gap-3.5">
                ...
                <div className="space-y-1.5">
                  <label className="text-[9px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 px-1">Node Alias</label>
                  <div className="relative group">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors" size={16} />
                    <input
                      type="text"
                      required
                ...
                {/* Neural Mail */}
                <div className="space-y-1.5">
                  <label className="text-[9px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 px-1">Neural Mail</label>
                  <div className="relative group">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <label className="text-[9px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 px-1">Cipher</label>
                    <div className="relative group">
                      ...
                      />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-blue-600">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[9px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400 px-1">Verify</label>
                    <div className="relative group">
                      <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 group-focus-within:text-blue-500 transition-colors" size={16} />
                      <input
                      ...
                      />
                      <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-blue-600">
