...
export default function Header() {
  ...
  return (
    <header className="h-16 md:h-20 px-4 md:px-10 flex items-center justify-between border-b border-zinc-200 dark:border-white/25 bg-white/96 dark:bg-black/50 backdrop-blur-md transition-all duration-500 z-[90] sticky top-0">
  ...
  <div className="flex items-center gap-2 overflow-hidden">
    <span className="relative text-[13px] md:text-[11px] font-black uppercase tracking-[0.2em] md:tracking-[0.5em] flex items-center">
      ...
      <span className="bg-clip-text text-transparent bg-gradient-to-br from-blue-600 to-blue-400 dark:from-blue-500 dark:to-blue-300">
        <span className="xs:hidden">JGEC Vault</span>
        <span className="hidden xs:inline md:hidden">JGEC Terminal</span>
        <span className="hidden md:inline">jalpaiguri government engineering college</span>
      </span>
      
      {/* Subtle Scanline Animation Effect */}
      <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] pointer-events-none" />
    </span>
  ...
  <div className="flex items-center gap-2 mt-0.5">
    <div className="h-[1px] w-3 bg-blue-600/30 dark:bg-blue-400/20" />
    <span className="font-mono text-[7px] md:text-[8px] font-bold opacity-50 dark:opacity-30 uppercase tracking-[0.25em] text-zinc-500 dark:text-white whitespace-nowrap">
      System.Stable // <span className="text-blue-600 dark:text-blue-400">Node_01</span>
    </span>
  </div>

  {/* Bottom Decorative Border (Cyberpunk style) */}
  <div className="absolute -bottom-2 left-0 w-0 h-[1px] bg-blue-600/50 group-hover:w-full transition-all duration-700" />
</div>
