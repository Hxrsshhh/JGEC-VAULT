...
const Sidebar = () => {
            ...
            >
              <div className="flex items-center gap-4 z-10">
                ...
                <span className={`text-[10px] font-black uppercase tracking-[0.15em] transition-all ${
                  isActive ? "opacity-100 translate-x-1" : "opacity-60 group-hover:opacity-100"
                }`}>
                  {label}
                </span>
              </div>
  ...
  <div className="p-6 mt-auto border-t border-zinc-200 dark:border-white/5 space-y-2 bg-zinc-50/50 dark:bg-black/20">
    ...
    {/* <button className="w-full flex items-center gap-4 p-3.5 rounded-xl text-red-500/60 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-500/5 transition-all group border border-transparent hover:border-red-500/20">
      <div className="relative w-5 h-5 flex items-center justify-center">
         <Radio size={18} className="group-hover:animate-ping absolute inset-0 opacity-20" />
         <LogOut size={16} className="relative z-10 group-hover:scale-110 transition-transform" />
      </div>
